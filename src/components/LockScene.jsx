function LockScene({ isLocked, onToggleLock }) {
  return (
    <div className="absolute top-1/2 ml-4 transform -translate-y-1/2 flex flex-col gap-2 bg-[#2F424B] p-2 rounded-lg cursor-pointer hover:bg-[#435964]" onClick={onToggleLock}>
      <img
