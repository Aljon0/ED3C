function Features(){
    ...
    return(
            <section className="features flex justify-center pt-20 min-h-screen pb-8 px-[9%] bg-[#2F424B]" id="features">
                <div className="text-white text-center " data-aos="fade-right">
                    <span className="text-4xl font-semibold italic text-center text-white   ">FEATURES</span>
                    <h1 className="text-base pt-2">ETERNAL DESIGN: INTERACTIVE 3D CUSTOMIZATION FOR 
