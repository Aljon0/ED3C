...
function OwnerSideBar() {
    return (
        <>
            <div className="flex">
                <aside className="fixed top-0 left-0 w-64 h-full bg-[#2F424B] text-white pt-24 overflow-y-auto z-20">
                    ...
                    <NavLink
                        ...
                        >
                            <img src="/assets/material-symbols--dashboard-outline-rounded.svg" className="w-6 h-6 mr-2 group-hover:fill-current group-hover:text-white" />Dashboard
                        </NavLink>
                        <NavLink
                            to="/owner/messages"
                            className={({ isActive }) =>
                        ...
                        >
                            <img
                                src="/assets/mdi--text-box-multiple-outline.svg"
                                className="w-6 h-6 mr-2 group-hover:fill-current group-hover:text-white"
                            />
                            Reports
                        </NavLink>
