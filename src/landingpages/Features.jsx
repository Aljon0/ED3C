function Features(){
    ...
    return(
            <section className="features flex justify-center min-h-screen pt-20 pb-8 px-[9%] bg-[#CACACA]" id="features">
                <div className="text-black text-center " data-aos="fade-right">
                    <span className="text-7xl font-semibold italic text-center text-[#37474F]">FEATURES</span>
                    <h1 className="text-4xl pt-2">ETERNAL DESIGN: INTERACTIVE 3D CUSTOMIZATION FOR 
                    ...
                    <div className="flex flex-wrap justify-center mt-8 space-x-8">
                        ...
                        <div className="flex flex-col items-center w-64">
                            <img src="/assets/mdi--user-multiple-check-outline.svg" className="w-16 h-16"/>
